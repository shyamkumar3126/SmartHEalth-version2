      ...
      <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className={`p-3 rounded-xl border flex flex-col items-center gap-2 transition ${
                type === 'In-Clinic' ? 'border-primary-600 bg-primary-50 text-primary-700' : 'border-gray-200 hover:bg-gray-50'
              }`}
            >
              <MapPin size={20} />
            ...
            <button
              ...
              className={`p-3 rounded-xl border flex flex-col items-center gap-2 transition ${
                type === 'Video' ? 'border-primary-600 bg-primary-50 text-primary-700' : 'border-gray-200 hover:bg-gray-50'
              }`}
            >
        ...
        <div className="border-t border-gray-100 pt-4 flex justify-between items-center">
           ...
           <button
             ...
             onClick={() => selectedSlot && onBook(selectedSlot, type)}
